...
const Login = () => {
  ...
  const [loginRequest, loginState] = useAsync(api.auth.login);

  const handleSubmit = useCallback((ev) => {
    ev.preventDefault();
    loginRequest(form.values);
  }, [form.values, loginRequest])
        ...
        <form className={styles.form} noValidate onSubmit={handleSubmit}>
          ...
          <div className={styles.formContainer}>
            ...
            <button
              ...
              disabled={!form.isStepValid || loginState.isLoading}
            >
              Login
            </button>
